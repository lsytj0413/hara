...
type Record struct {
	...
	// xxxx
	PreCrc    uint32 `protobuf:"varint,1,opt,name=pre_crc,json=preCrc,proto3" json:"pre_crc,omitempty"`
...
func (x *Record) GetPreCrc() uint32 {
	if x != nil {
		return x.PreCrc
	}
	return 0
...
func (x *Record) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_wal_proto_rawDesc = []byte{
	...
	0x01, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x72, 0x65,
	0x5f, 0x63, 0x72, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x70, 0x72, 0x65, 0x43,
	0x72, 0x63, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x72, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x03, 0x63, 0x72, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x66, 0x66, 0x73,
	...
	0x74, 0x61, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
